...
Figure 2 compares the number of total mutations between male and female hosts from the different municipalities. There appears to be significant difference between the mutation rate in the genome of virus from female and male host. However, I also observed that the number of sample from female host and male host are significantly different for many municipalities (Table 1). That would skew the comparison between the total count of mutations for male and females, the total mutation count is divided by the number of sample for that host sex. This averaged count plotted in Figure 3 provide a better comparison and clearly depicts that normalized count are approximately similar in male and female in municipalities. 
